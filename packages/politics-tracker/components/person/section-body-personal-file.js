  ...
  return (
    <SectionBody shouldShowSectionBody={isActive}>
      <Content
        ...
        GAClick={() => {
          logGAEvent('click', '點擊「基本資料」區塊的「編輯」')
        }}
        editContent={
          <EditContentBasic
      ...
      >
        ...
        <Sources
          sources={source}
          GAClick={() => {
            logGAEvent('click', '點擊「基本資料」區塊的「展開來源」')
          }}
        />
      </Content>
      ...
      >
        ...
        <Sources
          sources={source}
          GAClick={() => {
            logGAEvent('click', '點擊「經歷」區塊的「展開來源」')
          }}
        />
      </Content>
      ...
      <Content
        ...
        GAClick={() => {
          logGAEvent('click', '點擊「聯絡方式」區塊的「編輯」')
        }}
        editContent={
          <EditContentContact
            personId={id}
      ...
      >
        ...
        <Sources
          sources={source}
          GAClick={() => {
            logGAEvent('click', '點擊「聯絡方式」區塊的「展開來源」')
          }}
        />
      </Content>
      <Content
