    ...
    <div className="fixed inset-0 z-20 flex items-center justify-center bg-lightbox-dark">
      <div className="flex max-w-[278px] flex-col rounded-md bg-white px-5 py-4">
        <section className="mb-5">
          <p className="title-2">
            {t('Pages.Profile.BlockSheet-title', '封鎖 {{customId}}？', {
              customId,
            })}
          </p>
          <p className="body-3">
            {t(
              'Pages.Profile.BlockSheet-description',
        ...
        <section className="flex justify-end">
          ...
          <Button
            ...
            text={t('Pages.Profile.BlockSheet-confirm', '好的')}
            onClick={onClose}
          />
          <Button
            size="sm"
            color="custom-blue"
            text={t('Pages.Profile.BlockSheet-cancel', '取消')}
            onClick={onClose}
          />
        </section>
      </div>
