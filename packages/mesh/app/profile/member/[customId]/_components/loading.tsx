export default function Loading() {
  return (
    <div className="flex grow flex-col">
      <div className="flex animate-pulse items-center gap-4 p-5 pb-6 sm:gap-6 sm:pb-4 sm:pt-2 lg:px-10">
      ...
      <div className="flex items-center justify-center sm:justify-start">
        <div className="mb-8 mt-6 flex items-center gap-3 sm:m-0 sm:mb-6 sm:gap-5 sm:px-5">
      ...
      <div className="button-large mb-4 ml-5 hidden w-[180px] items-center justify-center rounded-md border border-primary-800 py-[13px] sm:flex">
        編輯個人檔案
      </div>
      <div className="flex animate-pulse border-y border-[rgba(0,9,40,0.1)] sm:gap-2 sm:border-t-0 sm:px-5">
